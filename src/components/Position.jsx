...
<<<<<<< HEAD
        <div className="text first absolute left-1 md:left-2 2xl:left-4 flex" aria-label="Data Analyst">
          {produceSpans("Software Developer", "animate-textRotate1")}
        </div>
        <div className="text second absolute left-1 md:left-2 2xl:left-4 flex" aria-label="NLP Specialist">
